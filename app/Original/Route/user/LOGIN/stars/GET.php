            ...
            if (preg_match('/^[A-Za-z0-9_-]{2,64}$/u', $login)) {
                ...
                if (0 < $min[User::ID]) {
                    ...
                    if ([] != $list) {
                        ...
                        $this->setTemplate('user/feedback.html.php');
                    }
                }
            }
        }
