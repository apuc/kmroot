<?php
namespace Original\Route_index_ssi_series_foreign;
...
class GET extends DefaultController
{
    ...
    public function index()
    {
        ...
        $result = $this->mysql()->query("SELECT t1.`id`, t1.`s`, t1.`image`, t1.`publish`, t1.`title`, t1.`anons`, t2.`comment` 
                                         ...
                                         WHERE t1.`status` = 'show' AND t1.`category` = 'Зарубежные сериалы'
        ...
        $this->setTemplate('index/ssi/series.foreign.html.php');
    }
}