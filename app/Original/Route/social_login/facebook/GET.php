<?php
namespace Original\Route_social_login_facebook;

use Dspbee\Auth\Token\Token;
use Kinomania\Original\Auth\Social\Fb;
...
class GET extends DefaultController
{
    ...
    {
        $fb = new Fb();
        $userInfo = $fb->authorize();
        if (!$fb->error()) {
            $now = strtotime('now');

            $login = $this->mysql()->real_escape_string($userInfo['id'] ?? '');
