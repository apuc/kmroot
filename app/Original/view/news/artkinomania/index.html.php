...
<head>
    ...
    <title>KINOMANIA.RU :: Арткиномания</title>
    ...
    <meta property="og:title" content="Арткиномания" />
                            ...
                            <div class="pagelist-item clear">
                                <div class="pagelist-item-image news-pagelist-item-image col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class=" image-shadow ">
                                        <a href="/news/<?= $item[News::ID] ?>/"><img width="365" height="199" alt="" src="//:0" data-original="<?= $item[News::IMAGE] ?>" class="lazy image-prewiew" ></a>
                                    </div>
                                </div>
                ...
                <div class="pagelist-social">
                    <div class="outer-social clear">
                        <ul class="social-list social-list--horizontal">
                            <li class="vk" id="vk_in_share" data-url="news/artkinomania"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fnews%2Fartkinomania/"><span class="number"></span></a></li>
                            <li class="fb" id="fb_in_share" data-url="news/artkinomania"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fnews%2Fartkinomania&t=%D0%90%D1%80%D1%82%D0%BA%D0%B8%D0%BD%D0%BE%D0%BC%D0%B0%D0%BD%D0%B8%D1%8F&src=sp/"><span class="number"></span></a></li>
                            <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?text=%D0%90%D1%80%D1%82%D0%BA%D0%B8%D0%BD%D0%BE%D0%BC%D0%B0%D0%BD%D0%B8%D1%8F&url=http%3A%2F%2Fkinomania.ru%2Fnews%2Fartkinomania/"></a></li>
                        </ul>
                    </div>
                </div>
            </content>
                        ...
                        for (var key in data) {
                            if (data.hasOwnProperty(key) && /^0$|^[1-9]\d*$/.test(key) && key <= 4294967294) {
                                var html = '<div class="pagelist-item clear">' +
                                    '<div class="pagelist-item-image news-pagelist-item-image col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">' +
                                    '<div class=" image-shadow ">' +
                                    '<a href="/news/' + data[key][<?= News::ID ?>] + '/"><img width="365" height="199" alt="" src="//:0" data-original="' + data[key][<?= News::IMAGE ?>] + '" class="lazy image-prewiew" ></a>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="pagelist-item-content news-pagelist-item-content col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">' +
                                    '<div class="pagelist-item-title">' +
