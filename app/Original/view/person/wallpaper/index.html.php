...
<head>
    ...
    <title><?= $min[Person::TITLE] ?>: обои для рабочего стола (<?= $stat[\Kinomania\Original\Key\Person\Stat::WALLPAPER] ?> шт.) | Все размеры до FULL-HD | KINOMANIA.RU</title>
    <meta name="description" content="<?= $min[Person::TITLE] ?>: обои на KINOMANIA.RU. Фильмография, биография, факты, новости и многое другое о звёздах мирового кинематографа."/>
                                        ...
                                        <ul class="wall-size-list">
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1600x1200] ?>" data-type-over-desc-desc="1600x1200" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1600x1200/" class="parent">1600x1200</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1280x960] ?>" data-type-over-desc-desc="1280x960" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1280x960/" class="parent">1280x960</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1024x768] ?>" data-type-over-desc-desc="1024x768" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1024x768/" class="parent">1024x768</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_800x600] ?>" data-type-over-desc-desc="800x600" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_800x600/" class="parent">800x600</a>
                                                </li>
                                            <?php endif ?>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="wall-size-list">
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1920x1200] ?>" data-type-over-desc-desc="1920x1200" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1920x1200/" class="parent">1920x1200</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1680x1050] ?>" data-type-over-desc-desc="1680x1050" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1680x1050/" class="parent">1680x1050</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1440x900] ?>" data-type-over-desc-desc="1440x900" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1440x900/" class="parent">1440x900</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1280x800] ?>" data-type-over-desc-desc="1280x800" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1280x800/" class="parent">1280x800</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_960x600] ?>" data-type-over-desc-desc="960x600" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_960x600/" class="parent">960x600</a>
                                                </li>
                                            <?php endif ?>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="wall-size-list">
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1920x1080] ?>" data-type-over-desc-desc="1920x1080" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1920x1080/" class="parent">1920x1080</a>
                                                </li>
                                            <?php endif ?>
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1366x768] ?>" data-type-over-desc-desc="1366x768" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1366x768/" class="parent">1366x768</a>
                                                </li>
                                            <?php endif ?>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="wall-size-list">
                                            ...
                                            <?php else :?>
                                                <li data-type-over-img="<?= $item[Wallpaper::R_1280x1024] ?>" data-type-over-desc-desc="1280x1024" data-type-over-desc=".desc-in-over">
                                                    <a href="/people/<?= $id ?>/wallpapers/<?= $item[Wallpaper::ID] ?>/wallpaper_1280x1024/" class="parent">1280x1024</a>
                                                </li>
                                            <?php endif ?>
                                        </ul>
                                    </div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="people/<?= $id ?>/wallpapers"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Fwallpapers/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="people/<?= $id ?>/wallpapers"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Fwallpapers&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Fwallpapers/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
