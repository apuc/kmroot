...
<head>
    ...
    <meta property="og:url" content="http://www.kinomania.ru/soundtracks" />
    <meta property="og:title" content="Саундтреки к фильмам" />
    <meta property="og:description" content="Саундтреки к фильмам: новые и популярные саундтреки к фильмам и сериалам."/>
                    ...
                    <div class="row-mini-slide row-mini-slide--two row-mini-slide--gray popular_block">
                        ...
                        <div class="row-bx-mini-slider">
                            <div class="bx-mini-slider bx-mini-slider-posters posters--hover">
                                ...
                                <div class="slide"><a href="/film/<?= $item[Soundtrack::FILM_ID] ?>/soundtracks/" class=""><img src="<?= $item[Soundtrack::IMAGE] ?>"></a>
                                    <div class="bx-mini-slider-caption">
                                        <div class="poster-title"><a href="/film/<?= $item[Soundtrack::FILM_ID] ?>/soundtracks/"><?= $item[Soundtrack::FILM_NAME] ?></a></div>
                                        <div class="poster-title-eng"><?= $item[Soundtrack::FILM_NAME_EN] ?></div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
                                ...
                                <?php foreach ($list as $item): ?>
                                    <div class="posters-item posters-item-tile">
                                        <div class="row-posters__image">
                                            <a href="/film/<?= $item[Soundtrack::FILM_ID] ?>/soundtracks/">
                                                <div class="image-shadow-poster posters__image">
                                                    <img width="205" height="205" alt="" src="//:0" data-original="<?= $item[Soundtrack::IMAGE] ?>" class="lazy parent responsive-image image-prewiew">
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="soundtracks"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fsoundtracks/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="soundtracks"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fsoundtracks&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Fsoundtracks/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
                ...
                for (var key in data) {
                    if (data.hasOwnProperty(key) && /^0$|^[1-9]\d*$/.test(key) && key <= 4294967294) {
                        html +=  '   <div class="posters-item posters-item-tile">  '  +
                            '   	<div class="row-posters__image">  '  +
                            '   		<a href="/film/' + data[key][<?= Soundtrack::FILM_ID ?>] + '/soundtracks/">  '  +
                            '   			<div class="image-shadow-poster posters__image">  '  +
                            '   				<img width="205" height="205" alt="" src="//:0" data-original="' + data[key][<?= Soundtrack::IMAGE ?>] + '" class="lazy parent responsive-image image-prewiew">  '  +
                            '   			</div>  '  +
                            '   		</a>  '  +
                            '   	</div>  '  +
                            '   	<div class="posters-caption">  '  +
                            '   		<div class="poster-title"><a href="/film/' + data[key][<?= Soundtrack::FILM_ID ?>] + '/soundtracks/">' + data[key][<?= Soundtrack::FILM_NAME ?>] + '</a></div>  '  +
                            '   		<div class="poster-title-eng">' + data[key][<?= Soundtrack::FILM_NAME_EN ?>] + '</div>  '  +
                            '   	</div>  '  +
                            '  </div>  ' ;
                    }
                }
