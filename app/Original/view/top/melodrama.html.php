...
<head>
    ...
    <title><?= $options->get('seo_top_melodrama_title') ?></title>
    <meta name="description" content="<?= $options->get('seo_top_melodrama_description') ?>"/>

	<link rel="canonical" href="http://www.kinomania.ru/top/melodrama"/>
            ...
            <section class=" outer-section clear outer-content">
                ...
                <content class="page-section-content section-content content-outer content-top--padding col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="row-top-films">
                        <h1 class="pagetitle"><?= $options->get('seo_top_melodrama_h1') ?></h1>
                        <div class="description">
	                        <?= $options->get('seo_top_melodrama_description') ?>
                        </div>
                        <div class="row-top">
                            <div class="top-forms">
                                <form action="">
