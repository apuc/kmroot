...
<head>
    ...
    <title>Кадр #<?= $frameId ?> из фильма <?= $min[Film::TITLE] ?> | KINOMANIA.RU</title>
    <?php if ('' == $min[Film::NAME_RU]): ?>
        <meta name="description" content="Кадр #<?= $frameId ?> из фильма «<?= $min[Film::NAME_ORIGIN] ?>» на сайте KINOMANIA.RU"/>
        <meta name="keywords" content="<?= $min[Film::NAME_ORIGIN] ?>, фильм, кадр"/>
    <?php else: ?>
        <meta name="description" content="Кадр #<?= $frameId ?> из фильма «<?= $min[Film::NAME_RU] ?>» на сайте KINOMANIA.RU"/>
        <meta name="keywords" content="<?= $min[Film::NAME_RU] ?>, <?= $min[Film::NAME_ORIGIN] ?>, фильм, кадр"/>
    <?php endif ?>

    <meta property="og:title" content="Кадр #<?= $frameId ?> из фильма <?= $min[Film::TITLE] ?>" />
    ...
    <?php endif ?>
            ...
            <section class="outer-section clear outer-content">
                ...
                <content class="pagelist page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="posters-caption">
                        <img alt="Кадр из фильма <?= $min[Film::TITLE] ?> <?php foreach ($list['item'][Frame::CAST] as $cast): ?> <?= $cast[1] ?> <?php endforeach; ?>" src="<?= $list['item'][Frame::IMAGE] ?>" />
                    </div>
                    <br />
                    <?php if (count($list['item'][Frame::CAST])): ?>
                        <p class="text name">
                            На кадре:
                            <?php foreach ($list['item'][Frame::CAST] as $cast): ?>
                    ...
                    <div class="list_page">
                        ...
                        <?php foreach ($list['list'] as $item): ?>
                            <?php if ($frameId == $item): ?>
                                <a href="#"><b><?= $page ?></b></a>
                            <?php else: ?>
                                <a href="/film/<?= $id ?>/frames/<?= $item ?>/"><?= $page ?></a>
                            <?php endif ?>
                            <?php $page++ ?>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="film/<?= $id ?>/frames/<?= $frameId ?>"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fframes%2F<?= $frameId ?>/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="film/<?= $id ?>/frames/<?= $frameId ?>"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fframes%2F<?= $frameId ?>&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fframes%2F<?= $frameId ?>/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
