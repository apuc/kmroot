                ...
                <content class="page-section-content section-content content-outer content-top--padding col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="row-list-nav-three">
                        <ul class="list-nav-second clear">
                            <li><a href="/releases/russia/">ПРЕМЬЕРЫ РФ</a></li>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="releases/usa"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Freleases%2Fusa/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="releases/usa"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Freleases%2Fusa&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Freleases%2Fusa/"></a></li>
                            </ul>
                        </div>
