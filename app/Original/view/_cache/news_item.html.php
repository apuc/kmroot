                ...
                <div class="row-news-item">
                    ...
                    <div class="page-item-info clear">
                        <div class="page-item-info--left">
                            <div class="page-item-info__author">
                                <?php if (0 != $item[News::AUTHOR_ID]): ?>
                                    Автор: <a href="/user/<?= $item[News::AUTHOR_LOGIN] ?>/" class="author__name"><?= $item[News::AUTHOR_NAME] ?></a>
                                <?php else: ?>
                                    &nbsp;
                                <?php endif ?>
                            </div>
                        ...
                        <div class="page-item-info--right">
                            <div class="page-item-info__date"><?= $item[News::PUBLISH] ?></div>
                        </div>
                    </div>
                ...
                <div class="pagelist-social news-pagelist-social">
                    <div class="outer-social clear">
                        <ul class="social-list social-list--horizontal">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="news/<?= $newsId ?>"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fnews%2F<?= $newsId ?>/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="news/<?= $newsId ?>"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fnews%2F<?= $newsId ?>/&t=<?= $item[News::TITLE_ENCODED] ?>&src=sp"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?text=<?= $item[News::TITLE_ENCODED] ?>&url=http%3A%2F%2Fkinomania.ru%2Fnews%2F<?= $newsId ?>/"></a></li>
                            </ul>
                        </ul>
                        <br /> <br /> <br /> <br />
                    </div>
