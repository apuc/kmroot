...
<head>
    ...
    <meta property="og:title" content="Фотографии актеров и актрис" />
    <meta property="og:description" content="Большая коллекция фотографий с самыми популярными актерами и актрисами кино и сериалов."/>
        ...
        <div class="main-content-other-page clear">
            <section class="outer-section clear outer-content">
                ...
                <content class="page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="item ganre">
                                        <div class="selection-trailers__value">
                                            <ul class="selection-trailers__value-list">
                                                <li><a href="#" data-value="male" class="filter sex">актер</a></li>
                                                <li><a href="#" data-value="female" class="filter sex">актриса</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="item ganre">
                    ...
                    <div class="row-mini-slide row-mini-slide--two row-mini-slide--gray popular_block">
                        ...
                        <div class="row-bx-mini-slider">
                            <div class="bx-mini-slider bx-mini-slider-posters posters--hover">
                                ...
                                <div class="slide"><a href="/people/<?= $item[Photo::PERSON_ID] ?>/photos/" class=""><img src="<?= $item[Photo::IMAGE] ?>"></a>
                                    <div class="bx-mini-slider-caption">
                                        <div class="poster-title"><a href="/people/<?= $item[Photo::PERSON_ID] ?>/photos/"><?= $item[Photo::PERSON_NAME] ?></a></div>
                                        <div class="poster-title-eng"><?= $item[Photo::PERSON_NAME_EN] ?></div>
                                        <div class="poster-number"><span class="value"><?= $item[Photo::COUNT] ?></span> шт</div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
                                ...
                                <?php foreach ($list as $item): ?>
                                    <div class="posters-item posters-item-tile">
                                        <div class="row-posters__image">
                                            <a href="/people/<?= $item[Photo::PERSON_ID] ?>/photos/">
                                                <div class="image-shadow-poster posters__image">
                                                    <img alt="" src="//:0" data-original="<?= $item[Photo::IMAGE] ?>" class="lazy parent responsive-image image-prewiew">
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="photos"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fphotos/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="photos"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fphotos&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Fphotos/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
                ...
                for (var key in data) {
                    if (data.hasOwnProperty(key) && /^0$|^[1-9]\d*$/.test(key) && key <= 4294967294) {
                        html +=  '   <div class="posters-item posters-item-tile">  '  +
                            '   	<div class="row-posters__image">  '  +
                            '   		<a href="/people/' + data[key][<?= Photo::PERSON_ID ?>] + '/photos/">  '  +
                            '   			<div class="image-shadow-poster posters__image">  '  +
                            '   				<img alt="" src="//:0" data-original="' + data[key][<?= Photo::IMAGE ?>] + '" class="lazy parent responsive-image image-prewiew">  '  +
                            '   			</div>  '  +
                            '   		</a>  '  +
                            '   	</div>  '  +
                            '   	<div class="posters-caption">  '  +
                            '   		<div class="poster-title"><a href="/people/' + data[key][<?= Photo::PERSON_ID ?>] + '/photos/">' + data[key][<?= Photo::PERSON_NAME ?>] + '</a></div>  '  +
                            '   		<div class="poster-title-eng">' + data[key][<?= Photo::PERSON_NAME_EN ?>] + '</div>  '  +
                            '   		<div class="poster-number"><span class="value">' + data[key][<?= Photo::COUNT ?>] + '</span> шт</div>  '  +
                            '   	</div>  '  +
                            '  </div>  ' ;
                    }
                }
    ...
    $(document).ready(function(){
        ...
        $('.filter').click(function(e){
            ...
            if ($(this).hasClass('sex')) {
                ...
                if(-1 == FILTER.sex.indexOf(sex)) {
                    FILTER.sex.push(sex);
                    $(this).addClass('active');
                } else {
                    FILTER.sex.splice(FILTER.sex.indexOf(sex), 1);
