                    ...
                    <div class="row-mini-slide row-mini-slide--two row-mini-slide--gray popular_block">
                        ...
                        <div class="row-bx-mini-slider">
                            <div class="bx-mini-slider bx-mini-slider-posters posters--hover">
                                ...
                                <div class="slide"><a href="/film/<?= $item[Poster::FILM_ID] ?>/posters/" class=""><img src="<?= $item[Poster::IMAGE] ?>"></a>
                                    <div class="bx-mini-slider-caption">
                                        <div class="poster-title"><a href="/film/<?= $item[Poster::FILM_ID] ?>/posters/"><?= $item[Poster::FILM_NAME] ?></a></div>
                                        <div class="poster-title-eng"><?= $item[Poster::FILM_NAME_EN] ?></div>
                                        <div class="poster-number"><span class="value"><?= $item[Poster::COUNT] ?></span> шт</div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
                                ...
                                <?php for ($i = 0; $i < 6; $i++): ?>
                                    ...
                                    <div class="posters-item posters-item-tile">
                                        <div class="row-posters__image">
                                            <a href="/film/<?= $item[Poster::FILM_ID] ?>/posters/">
                                                <div class="image-shadow-poster posters__image">
                                                    <img alt="" src="//:0" data-original="<?= $item[Poster::IMAGE] ?>" class="lazy parent responsive-image image-prewiew">
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="posters"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fposters/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="posters"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fposters&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Fposters/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
                ...
                for (var key in data) {
                    if (data.hasOwnProperty(key) && /^0$|^[1-9]\d*$/.test(key) && key <= 4294967294) {
                        html +=  '   <div class="posters-item posters-item-tile">  '  +
                            '   	<div class="row-posters__image">  '  +
                            '   		<a href="/film/' + data[key][<?= Poster::FILM_ID ?>] + '/posters/">  '  +
                            '   			<div class="image-shadow-poster posters__image">  '  +
                            '   				<img alt="" src="//:0" data-original="' + data[key][<?= Poster::IMAGE ?>] + '" class="lazy parent responsive-image image-prewiew">  '  +
                            '   			</div>  '  +
                            '   		</a>  '  +
                            '   	</div>  '  +
                            '   	<div class="posters-caption">  '  +
                            '   		<div class="poster-title"><a href="/film/' + data[key][<?= Poster::FILM_ID ?>] + '/posters/">' + data[key][<?= Poster::FILM_NAME ?>] + '</a></div>  '  +
                            '   		<div class="poster-title-eng">' + data[key][<?= Poster::FILM_NAME_EN ?>] + '</div>  '  +
                            '   		<div class="poster-number"><span class="value">' + data[key][<?= Poster::COUNT ?>] + '</span> шт</div>  '  +
                            '   	</div>  '  +
                            '  </div>  ' ;
                    }
                }
