...
<head>
    ...
    <title><?= $min[Person::TITLE] ?>: видео актера, эпизоды из фильмов, портфолио | KINOMANIA.RU</title>
    ...
    <meta property="og:url" content="http://www.kinomania.ru/people/<?= $id ?>/trailers" />
                ...
                <content class="pagelist page-section-content section-content content-outer outer-vert col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-pagelist header-search header-pagelist--black">
                        <div class="inner-header-pagelist">
                            <div class="pagelist-title-black ">Видео <span class="number--opacity"><?= $stat[\Kinomania\Original\Key\Person\Stat::VIDEO] ?></span></div>
                                        ...
                                        <div class="trailer-list-item">
                                            ...
                                            <div class="head-desc clear">
                                                <div class="trailer__title">
                                                    ...
                                                    <p class="title"><?= $list[0][Trailer::FILM_NAME] ?></p>
                        ...
                        <?php for ($i = 1; $i < $count; $i++): ?>
                            ...
                            <div class="trailer-item clear">
                                ...
                                <div class="row-trailer-text">
                                    <div class="trailer-list-title"><a href="/film/<?= $list[$i][Trailer::FILM_ID] ?>/trailers/<?= $list[$i][Trailer::ID] ?>/"><?= $list[$i][Trailer::NAME] ?></a> &nbsp; <?= $list[$i][Trailer::FILM_NAME] ?></div>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="people/<?= $id ?>/trailers"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Ftrailers/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="people/<?= $id ?>/trailers"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Ftrailers&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Fpeople%2F<?= $id ?>%2Ftrailers/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
