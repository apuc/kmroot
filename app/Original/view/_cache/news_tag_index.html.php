...
<head>
    ...
    <title>KINOMANIA.RU :: Новости по тегу `<?= $tag ?>`</title>
    ...
    <meta property="og:url" content="http://www.kinomania.ru/tag/<?= $tagId ?>" />
    <meta property="og:description" content="Архив новостей по тегу `<?= $tag ?>`: все новости о мире кино и жизни актеров"/>
                            ...
                            <div class="pagelist-item clear">
                                <div class="pagelist-item-image news-pagelist-item-image col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class=" image-shadow ">
                                        <a href="/<?= $item[News::CATEGORY] ?>/<?= $item[News::ID] ?>/"><img width="365" height="199" alt="" src="//:0" data-original="<?= $item[News::IMAGE] ?>" class="lazy image-prewiew" ></a>
                                    </div>
                                </div>
                                <div class="pagelist-item-content news-pagelist-item-content col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="pagelist-item-title">
                                        <a href="/<?= $item[News::CATEGORY] ?>/<?= $item[News::ID] ?>/"><?= $item[News::TITLE] ?></a>
                                    </div>
                                    <?= $item[News::ANONS] ?>
                                    <div class="pagelist-info">
                                        <span class="date__month"><?= $item[News::PUBLISH] ?></span>
                                        <?php if (!empty($item[News::COMMENT])): ?>
                                            <a href="/<?= $item[News::CATEGORY] ?>/<?= $item[News::ID] ?>#commentList/" class="pagelist__comments"><?= $item[News::COMMENT] ?></a>
                                        <?php endif ?>
                                    </div>
                                    <a href="/<?= $item[News::CATEGORY] ?>/<?= $item[News::ID] ?>/" class="pagelist__link">Подробнее</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <div class="pagelist-social">
                    <div class="outer-social clear">
                        <ul class="social-list social-list--horizontal">
                            <li class="vk" id="vk_in_share" data-url="tag/<?= $tagId ?>"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Ftag%2F<?= $tagId ?>/"><span class="number"></span></a></li>
                            <li class="fb" id="fb_in_share" data-url="tag/<?= $tagId ?>"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Ftag%2F<?= $tagId ?>&t=<?= $socTitle ?>&src=sp/"><span class="number"></span></a></li>
                            <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?text=<?= $socTitle ?>&url=http%3A%2F%2Fkinomania.ru%2Ftag%2F<?= $tagId ?>/"></a></li>
                        </ul>
                    </div>
                </div>
            </content>
                        ...
                        for (var key in data) {
                            if (data.hasOwnProperty(key) && /^0$|^[1-9]\d*$/.test(key) && key <= 4294967294) {
                                var html = '<div class="pagelist-item clear">' +
                                    '<div class="pagelist-item-image news-pagelist-item-image col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">' +
                                    '<div class=" image-shadow ">' +
                                    '<a href="/' + data[key][<?= News::CATEGORY ?>] + '/' + data[key][<?= News::ID ?>] + '/"><img width="365" height="199" alt="" src="//:0" data-original="' + data[key][<?= News::IMAGE ?>] + '" class="lazy image-prewiew" ></a>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="pagelist-item-content news-pagelist-item-content col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">' +
                                    '<div class="pagelist-item-title">' +
                                    '<a href="/' + data[key][<?= News::CATEGORY ?>] + '/' + data[key][<?= News::ID ?>] + '/">' + data[key][<?= News::TITLE ?>] + '</a>' +
                                    '</div>' +
                                    data[key][<?= News::ANONS ?>] +
                                    '<div class="pagelist-info">' +
                                    '<span class="date__month">' + data[key][<?= News::PUBLISH ?>] + '</span>';
                                if (0 < data[key][<?= News::COMMENT ?>]) {
                                    html += '<a href="/' + data[key][<?= News::CATEGORY ?>] + '/' + data[key][<?= News::ID ?>] + '#commentList/" class="pagelist__comments">' + data[key][<?= News::COMMENT ?>] + '</a>';
                                }
                                html += '</div>' +
                                    '<a href="/' + data[key][<?= News::CATEGORY ?>] + '/' + data[key][<?= News::ID ?>] + '/" class="pagelist__link">Подробнее</a>' +
                                    '</div>' +
                                    '</div>';
