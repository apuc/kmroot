...
<head>
    ...
    <title>Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?>  <?= $min[Film::TITLE] ?> | KINOMANIA.RU</title>
    <?php if ('' == $min[Film::NAME_RU]): ?>
        <meta name="description" content="Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?> «<?= $min[Film::NAME_ORIGIN] ?>» на сайте KINOMANIA.RU"/>
        <meta name="keywords" content="<?= $min[Film::NAME_ORIGIN] ?>, <?php if ('' == $item['type']): ?>фильм<?php else: ?>сериал<?php endif ?>, актеры, роли"/>
        
        <meta property="og:description" content="Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?> «<?= $min[Film::NAME_ORIGIN] ?>»"/>
    <?php else: ?>
        <meta name="description" content="Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?> «<?= $min[Film::NAME_RU] ?>» на сайте KINOMANIA.RU"/>
        <meta name="keywords" content="<?= $min[Film::NAME_RU] ?>, <?= $min[Film::NAME_ORIGIN] ?>, <?php if ('' == $item['type']): ?>фильм<?php else: ?>сериал<?php endif ?>, актеры, роли"/>
        
        <meta property="og:description" content="Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?> «<?= $min[Film::NAME_RU] ?>»"/>
    <?php endif ?>

    <meta property="og:title" content="Актёры и роли <?php if ('' == $item['type']): ?>фильма<?php else: ?>сериала<?php endif ?> <?= $min[Film::TITLE] ?>" />
                    ...
                    <div class="row-actors">
                        <div class="row-tabs">
                            <ul class="tabs-list clear">
                                ...
                                <li class="default" data-type-slidergroup="actors_creaters" data-type-sliderbutton="2"><a href="/film/<?= $id ?>/people/creators/"><span>СОЗДАТЕЛИ</span></a></li>
                            </ul>
                        </div>
                                    ...
                                    <div class="section-result-content clear">
                                        ...
                                        <div class="section-result-item item2 clear">
                                            <div class="row-result-tabs-item row-result-tabs-item--left">
                                                ...
                                                <div class="section-result-info">
                                                    <div class="actors-info-content">
                                                        <ul>
                                                            <?php if ('' != $person[4] || '' != $person[5]): ?>
                                                            <li class="actors-info-role">Роль - <?php if ('' != $person[4]): ?> <?= $person[4] ?> &nbsp; <?php endif ?> <?= $person[5] ?></li>
                                                            <?php endif ?>
                                            ...
                                            <div class="row-result-tabs-item--right">
                                                <?php if ('' != $person[11] || '' != $person[10]): ?>
                                                <div class="result-tabs-image">
                                                    <div class="list-preview" gallery-number="<?= $person[0] ?>">
                                                        <?php foreach ($person[14] as $k => $image): ?>
                                                            <?php if (0 == $k): ?>
                                                                <a href="<?= $person[14][0] ?>" class="parent">
                                                                    <img src="//:0"  data-original="<?= $person[13] ?>" alt="" class="lazy">
                                                                </a>
                                                            <?php else: ?>
                                                                <a href="<?= $image ?>" class="parent hidden"></a>
                                                            <?php endif ?>
                                                        <?php endforeach; ?>
                                                    </div>
                                                    <div class="result-tabs-caption"><a href="/people/<?= $person[0] ?>/frames"><?= $person[11] ?></a><a href="/people/<?= $person[0] ?>/trailers/"><?= $person[12] ?></a></div>
                                                </div>
                                                <?php endif ?>
                    ...
                    <div class="pagelist-social">
                        <div class="outer-social clear">
                            <ul class="social-list social-list--horizontal">
                                <li class="vk" id="vk_in_share" data-url="film/<?= $id ?>/people"><a href="http://vkontakte.ru/share.php?url=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fpeople/"><span class="number"></span></a></li>
                                <li class="fb" id="fb_in_share" data-url="film/<?= $id ?>/people"><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fpeople&src=sp/"><span class="number"></span></a></li>
                                <li class="tw" id="tw_in_share"><a href="http://twitter.com/share?url=http%3A%2F%2Fkinomania.ru%2Ffilm%2F<?= $id ?>%2Fpeople/"></a></li>
                            </ul>
                        </div>
                    </div>
                </content>
