...
<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" id="formCrop" class="saveScrollPosition">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="img-container mb-lg" style="max-height: none;">
                        <img id="cropImage" src="<?= $image ?>?<?= mt_rand(0, 9999999) ?>"
                    </div>
                </div>
            </div>
            ...
            <input type="hidden" name="id" id="photoId" value="<?= $id ?>" />
            <input type="hidden" name="crop" id="crop" value="0" />
            <input type="hidden" name="extension" id="extensionCrop" value="<?= $extension ?>" />
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#formCrop").submit(function(){
            ...
            fd.append('extension', $('#extensionCrop').val());
            ...
            $.ajax({
                ...
                success:function(data) {
                    if (1 == data.er) {
                        $.cookie('__alert__', 'Не удалось изменить изображение|red', { expires: 1, path: '/' });
                    } else {
