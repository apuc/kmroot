...
<div class="content-heading">
    ...
    Обои
    &nbsp; &nbsp;
    <a href="<?= Server::DEMO ?>/people/<?= $item->id() ?>/wallpapers/" target="_blank" class="smaller">Демо</a>
    &nbsp;
    <a href="<?= Server::MAIN ?>/people/<?= $item->id() ?>/wallpapers/" target="_blank" class="smaller">На сайте</a>
    <small>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.modalBtn').click(function(){
            ...
            window.photoId = id;
            $.ajax({
                url : '<?= $request->makeUrl('person/wallpaper?id=') ?>' + id,
                type: "GET",
