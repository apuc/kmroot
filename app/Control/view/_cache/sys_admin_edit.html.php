...
<div class="content-heading">Редактировать администратора</div>
            ...
            <div class="panel-wrapper">
                <div class="panel-body">
                    <form method="post" id="validateForm">
                        ...
                        <div class="form-group">
                            ...
                            <select name="group">
                                ...
                                <?php foreach ($groupList as $group): ?>
                                    <option value="<?= $group->id() ?>" <?php if ($admin->groupId() == $group->id()): ?> selected="selected" <?php endif ?>>
                                        <?= $group->name() ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <input type="hidden" name="groupIdPrev" value="<?= $admin->groupId() ?>" />
