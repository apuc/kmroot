...
<div class="content-heading">
    Настройка СЕО для страницы график премьер РФ
</div>
                        ...
                        <div class="dataTables_wrapper">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    <td>Title</td>
                                    <td>
                                        <input type="text" name="title" value="<?= $options->get('seo_releases_russia_title') ?>" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Description</td>
                                    <td>
                                        <input type="text" name="description" value="<?= $options->get('seo_releases_russia_description') ?>" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Keywords</td>
                                    <td>
                                        <input type="text" name="keywords" value="<?= $options->get('seo_releases_russia_keywords') ?>" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>H1</td>
                                    <td>
                                        <input type="text" name="h1" value="<?= $options->get('seo_releases_russia_h1') ?>" class="form-control">
                                    </td>
                                </tr>
                            </table>
                        </div>
