    ...
    <div class="modal-content">
        <form method="post" id="validateForm">
            <div class="modal-header">
                ...
                <h4 id="myModalLabel" class="modal-title">Добавить фильм</h4>
            </div>
                    ...
                    <div id="manual" role="tabpanel" class="tab-pane">
                        <div class="form-group">
                            ...
                            <div class="input-group col-lg-12">
                                <input type="text" name="name_ru" value="" id="name_ru" class="form-control" placeholder="Название на русском" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="year">Год</label>
                            <input type="text" name="year" value="" id="year" class="form-control" placeholder="Год выпуска" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    success:function(data) {
                        setTimeout(function(){
                            if ('' != data.error) {
                               ...
                               document.location = '/control/film/edit?id=' + data.id;
                            }
                        }, 500);
                    },
