...
<div class="content-heading">
    ...
    Постеры
    &nbsp; &nbsp;
    <a href="<?= \Kinomania\System\Config\Server::DEMO ?>/film/<?= $item->id() ?>/posters/" target="_blank" class="smaller">Демо</a>
    &nbsp;
    <a href="<?= \Kinomania\System\Config\Server::MAIN ?>/film/<?= $item->id() ?>/posters/" target="_blank" class="smaller">На сайте</a>
                ...
                <div class="panel-wrapper">
                    <div class="modal-body">
                        <table class="table">
                            ...
                            <?php
                            /**
                             * @var \Kinomania\Control\Film\Poster\Item $item
                             */
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $item->imageSrc() ?>" target="_blank">
                                            <img width="228" height="313" class="lazy" data-original="<?= $item->imageResizeSrc() ?>" src="//:0" />
                                        </a>
                                        <br />
                                                ...
                                                <form method="post" class="saveScrollPosition">
                                                    <div class="input-group">
                                                        <div class="checkbox c-checkbox needsclick wd">
                                                            <label class="needsclick">
                                                                <input type="checkbox" name="popular" <?php if ('yes' == $item->popular()): ?> checked="checked" <?php endif ?> class="needsclick">
                                                                <span class="fa fa-check"></span>
                                                                Популярное
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-btn">
                                                            <button type="submit" class="btn btn-default">Сохранить</button></span>
                                                    </div>
                                                    <br />
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.modalBtn').click(function(){
            ...
            window.photoId = id;
            $.ajax({
                url : '<?= $request->makeUrl('film/poster?id=') ?>' + id,
                type: "GET",
                success:function(data) {
