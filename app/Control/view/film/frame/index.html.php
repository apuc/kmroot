...
<div class="content-heading">
    ...
    Кадры
    &nbsp; &nbsp;
    <a href="<?= \Kinomania\System\Config\Server::DEMO ?>/film/<?= $item->id() ?>/frames/" target="_blank" class="smaller">Демо</a>
    &nbsp;
    <a href="<?= \Kinomania\System\Config\Server::MAIN ?>/film/<?= $item->id() ?>/frames/" target="_blank" class="smaller">На сайте</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $item->imageSrc() ?>" target="_blank">
                                            <img width="455" height="247" class="lazy" data-original="<?= $item->imageResizeSrc() ?>" src="//:0" />
                                        </a>
                                        <br />
                                            ...
                                            <div class="col-lg-12">
                                                <form method="post" class="saveScrollPosition">
                                                    <div class="input-group">
                                                        <div class="checkbox c-checkbox needsclick wd">
                                                            <label class="needsclick">
                                                                <input type="checkbox" name="photo_session" <?php if ('yes' == $item->photo_session()): ?> checked="checked" <?php endif ?> class="needsclick">
                                                                <span class="fa fa-check"></span>
                                                                Промо-кадры
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="checkbox c-checkbox needsclick wd">
                                                            <label class="needsclick">
                                                                <input type="checkbox" name="film_set" <?php if ('yes' == $item->film_set()): ?> checked="checked" <?php endif ?> class="needsclick">
                                                                <span class="fa fa-check"></span>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="checkbox c-checkbox needsclick wd">
                                                            <label class="needsclick">
                                                                <input type="checkbox" name="concept" <?php if ('yes' == $item->concept()): ?> checked="checked" <?php endif ?> class="needsclick">
                                                                <span class="fa fa-check"></span>
                                                                Концепт
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="checkbox c-checkbox needsclick wd">
                                                            <label class="needsclick">
                                                                <input type="checkbox" name="screenshot" <?php if ('yes' == $item->screenshot()): ?> checked="checked" <?php endif ?> class="needsclick">
                                                                <span class="fa fa-check"></span>
                                                                Скриншот
                                                            </label>
                                                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.modalBtn').click(function(){
            ...
            window.photoId = id;
            $.ajax({
                url : '<?= $request->makeUrl('film/frame?id=') ?>' + id,
                type: "GET",
        ...
        $('.personBtn').click(function(){
            ...
            window.photoId = id;
            $.ajax({
                url : '<?= $request->makeUrl('film/frame?handler=person&id=') ?>' + id,
                type: "GET",
                success:function(data) {
                    $('#modalWindow').html(data).modal({});
                    $(':file').filestyle();
